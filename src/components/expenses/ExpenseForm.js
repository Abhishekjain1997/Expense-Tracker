...
const Expenses = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isEdit === true) {
      ...
      fetch(
        `https://expense-tracker-eaba7-default-rtdb.firebaseio.com/userExpenses${userEmail}.json`,
        {
          method: "POST",
          body: JSON.stringify(expenseData),
          headers: {
  ...
  const deleteHandler = (id) => {
    fetch(
      `https://expense-tracker-eaba7-default-rtdb.firebaseio.com/userExpenses${userEmail}/${id}.json`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
